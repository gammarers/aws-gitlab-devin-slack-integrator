...
| <code><a href="#@gammarers/aws-gitlab-devin-slack-integrator.GitLabDevinSlackIntegrator.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@gammarers/aws-gitlab-devin-slack-integrator.GitLabDevinSlackIntegrator.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@gammarers/aws-gitlab-devin-slack-integrator.GitLabDevinSlackIntegrator.with.parameter.mixins"></a>
